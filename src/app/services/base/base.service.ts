...
export class BaseService<T> {
    ...
    constructor(
        ...
        protected fileService: FileService, protected router: Router, protected toastr: ToastrService, protected http: HttpClient
    ) {
    }

    setUpBaseService(
        route: ActivatedRoute,
        getService: Query<any, any>,
        deleteService: Mutation<any, any> | undefined,
        key: string,
        tableHeaders: TableHead<any>[],
        searchCriteria: any,
        mapTableData: any = (data: any) => data,
        objectPlural: string,
        objectSingle: string,) {
        ...
        this.mapTableData = mapTableData;
        this.route = route;
    ...
    setUpEditBaseService(setEditData: any) {
        this.setEditData = setEditData;
    }
    ...
    setEditData: any = () => {
        this.childComponent.setEditData(this.selectedItem);
    };
