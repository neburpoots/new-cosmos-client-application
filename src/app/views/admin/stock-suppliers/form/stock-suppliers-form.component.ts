...
import { AllBuildingsNoPaginationGQL, AllEndUsersNoPaginationGQL, AllFloorsNoPaginationGQL, AreaInput, Building, CreateAreaGQL, CreateGasGQL, EndUser, Floor, GasInput, StockSupplierInput, UpdateAreaGQL, UpdateGasGQL } from '../../../../../generated/graphql';
import { Query } from 'apollo-angular';
import { AuthService } from '../../../../services/authentication/auth.service';


@Component({
    selector: 'stock-suppliers-form',
    templateUrl: './stock-suppliers-form.component.html',
})
export class StockSuppliersFormComponent extends BaseFormComponent<StockSupplierInput> {
